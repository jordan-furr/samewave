      ...
      <div className="pageCont">
        <div className="mainContent">
          ...
          <div className="infoHalf desktop">
            ...
            <p className="mb3">Samewave 7 particpates in trades with other creatives and has sold goods for USD in the past. If the project is curious and open to creative control, commissions may be on the table.</p>
